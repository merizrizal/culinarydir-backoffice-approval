...
$this->params['breadcrumbs'][] = ['label' => $model->name, 'url' => ['status-approval-action/check-set-contact-person', 'id' => $id, 'appBId' => $appBId, 'actid' => $actid, 'logsaid' => $logsaid]];
            ...
            <div class="x_panel">
                <div class="registry-business-form">
                    ...
                    $form = ActiveForm::begin([
                        ...
                        'action' => ['update-contact-person', 'id' => $id, 'appBId' => $appBId, 'actid' => $actid, 'logsaid' => $logsaid],
                        'options' => [
                        ...
                        <div class="x_content">
                                	           ...
                                	           foreach ($dataRegistryBusinessContactPerson as $i => $dataContactPerson):
                                	               ...
                                	               $modelRegistryBusinessContactPerson->note = $dataContactPerson['note'];?>
                                	                ...
                                	                <div class="mb-40 data-form">
                                                        ...
                                                        <?= Html::hiddenInput('RegistryBusinessContactPersonExisted[' . $i . ']', $dataContactPerson['person_id'], ['class' => 'deleted-contact']) ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    echo Html::a('<i class="fa fa-times"></i> Cancel', ['status-approval-action/check-set-contact-person', 'id' => $id, 'appBId' => $appBId, 'actid' => $actid, 'logsaid' => $logsaid], ['class' => 'btn btn-default']); ?>
