...
$this->title = 'Check & Set ' . Yii::t('app', 'Payment Methods') . ' : ' . $model['name'];
            ...
            <div class="x_panel">
                <div class="x_content">
                    ...
                    $form = ActiveForm::begin([
                        ...
                        echo Html::hiddenInput('check_set_payment_method', true);

                        echo Html::submitButton('<i class="fa fa-check-circle"></i> OK & Save', ['class' => 'btn btn-success']);
                        echo ' ' . Html::a('<i class="fa fa-pencil-alt"></i> Edit', ['registry-business-payment/index', 'id' => $id, 'appBId' => $appBId, 'actid' => $actid, 'logsaid' => $logsaid], ['class' => 'btn btn-primary']);
